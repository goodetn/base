...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Quicksand:wght@300;600;700&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: #322525;\n  color: #d6ac88;\n  font-family: \"Quicksand\", sans-serif;\n  margin: 0;\n  padding: 20px;\n  overflow: hidden;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\n.container {\n  background-color: #d6ac88;\n  color: #322525;\n  border-radius: 10px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 50px 20px;\n  text-align: center;\n  max-width: calc(100% - 20px);\n  width: 800px;\n}\n\n.joke {\n  font-size: 30px;\n  line-height: 40px;\n  letter-spacing: 1px;\n  margin: 50px auto;\n  max-width: 600px;\n}\n\nh3 {\n  margin: 0;\n  letter-spacing: 2px;\n  padding-bottom: 10px;\n  border-bottom: 3px solid #9a6449;\n}\n\nimg {\n  width: 100px;\n  margin-bottom: 20px;\n}\n\n.btn {\n  background-color: #322525;\n  color: #d6ac88;\n  border: 0;\n  border-radius: 10px;\n  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 14px 40px;\n  font-style: 16px;\n  cursor: pointer;\n}\n.btn:active {\n  transform: scale(0.98);\n}\n.btn:focus {\n  outline: 0;\n}", "",{"version":3,"sources":["webpack://./styles/_common.scss","webpack://./styles/main.scss"],"names":[],"mappings":"AAoBA;EACE,yBArBW;EAsBX,cAlBI;EAmBJ,oCAAA;EACA,SAAA;EACA,aAAA;EACA,gBAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;ACjBF;;ADoBA;EACE,yBA/BI;EAgCJ,cApCW;EAqCX,mBAAA;EACA,wEArBW;EAsBX,kBAAA;EACA,kBAAA;EACA,4BAAA;EACA,YAAA;ACjBF;;ADoBA;EACE,eAAA;EACA,iBAAA;EACA,mBAAA;EACA,iBAAA;EACA,gBAAA;ACjBF;;ADoBA;EACE,SAAA;EACA,mBAAA;EACA,oBAAA;EACA,gCAAA;ACjBF;;ADoBA;EACE,YAAA;EACA,mBAAA;ACjBF;;ADoBA;EACE,yBAlEW;EAmEX,cA/DI;EAgEJ,SAAA;EACA,mBAAA;EACA,uEApDa;EAqDb,kBAAA;EACA,gBAAA;EACA,eAAA;ACjBF;ADmBE;EACE,sBAAA;ACjBJ;ADoBE;EACE,UAAA;AClBJ","sourcesContent":["$cocoaBrown: #322525;\n$buccaneer: #63342d;\n$capePalliser: #9a6449;\n$antiqueBrass: #c58d69;\n$tan: #d6ac88;\n$transparentColor01: rgba(0, 0, 0, 0.1);\n\n// re-defined to understand easier\n$light-color: $tan;\n$closeLight-color: $antiqueBrass;\n$middle-color: $capePalliser;\n$dark-color: $cocoaBrown;\n$closeDark-color: $buccaneer;\n\n$primary-color: $dark-color;\n$secondary-color: $light-color;\n\n$box-shadow: 0 10px 20px $transparentColor01, 0 6px 6px $transparentColor01;\n$box-shadow-2: 0 5px 15px $transparentColor01, 0 6px 6px $transparentColor01;\n\nbody {\n  background-color: $dark-color;\n  color: $light-color;\n  font-family: 'Quicksand', sans-serif;\n  margin: 0;\n  padding: 20px;\n  overflow: hidden;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\n.container {\n  background-color: $light-color;\n  color: $dark-color;\n  border-radius: 10px;\n  box-shadow: $box-shadow;\n  padding: 50px 20px;\n  text-align: center;\n  max-width: calc(100% - 20px);\n  width: 800px;\n}\n\n.joke {\n  font-size: 30px;\n  line-height: 40px;\n  letter-spacing: 1px;\n  margin: 50px auto;\n  max-width: 600px;\n}\n\nh3 {\n  margin: 0;\n  letter-spacing: 2px;\n  padding-bottom: 10px;\n  border-bottom: 3px solid $middle-color;\n}\n\nimg {\n  width: 100px;\n  margin-bottom: 20px;\n}\n\n.btn {\n  background-color: $primary-color;\n  color: $secondary-color;\n  border: 0;\n  border-radius: 10px;\n  box-shadow: $box-shadow-2;\n  padding: 14px 40px;\n  font-style: 16px;\n  cursor: pointer;\n\n  &:active {\n    transform: scale(0.98);\n  }\n\n  &:focus {\n    outline: 0;\n  }\n}\n","@import 'https://cdnjs.cloudflare.com/ajax/libs/normalize/8.0.1/normalize.min.css';\n@import url(\"https://fonts.googleapis.com/css2?family=Quicksand:wght@300;600;700&display=swap\");\nbody {\n  background-color: #322525;\n  color: #d6ac88;\n  font-family: \"Quicksand\", sans-serif;\n  margin: 0;\n  padding: 20px;\n  overflow: hidden;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\n.container {\n  background-color: #d6ac88;\n  color: #322525;\n  border-radius: 10px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 50px 20px;\n  text-align: center;\n  max-width: calc(100% - 20px);\n  width: 800px;\n}\n\n.joke {\n  font-size: 30px;\n  line-height: 40px;\n  letter-spacing: 1px;\n  margin: 50px auto;\n  max-width: 600px;\n}\n\nh3 {\n  margin: 0;\n  letter-spacing: 2px;\n  padding-bottom: 10px;\n  border-bottom: 3px solid #9a6449;\n}\n\nimg {\n  width: 100px;\n  margin-bottom: 20px;\n}\n\n.btn {\n  background-color: #322525;\n  color: #d6ac88;\n  border: 0;\n  border-radius: 10px;\n  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 14px 40px;\n  font-style: 16px;\n  cursor: pointer;\n}\n.btn:active {\n  transform: scale(0.98);\n}\n.btn:focus {\n  outline: 0;\n}"],"sourceRoot":""}]);
// Exports
...
"use strict";
module.exports = __webpack_require__.p + "colorBrand.png";
...
/* harmony import */ var _assets_colorBrand_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./assets/colorBrand.png */ "./src/assets/colorBrand.png");



var colorBrandEl = document.getElementById('colorBrandEl');
colorBrandEl.src = _assets_colorBrand_png__WEBPACK_IMPORTED_MODULE_2__;
...
/******/ })()
;
//# sourceMappingURL=bundle259cb51a557971026100.js.map